...
export default function FactureToPDF() {
    ...
    const downloadPDF=()=> {
        ...
        .then((canvas) => {
            ...
            pdf.save(`reception_${factureId}.pdf`);
        })
    }

    const getFactureInfo=()=> {
        axios.get(`http://localhost:8081/factureInfo/${factureId}`)
    ...
    <div className='factureContent'>
        ...
        <div id="divToPrint">
            ...
            <TableContainer component={Paper} className="tableFacture">
                <Table sx={{ minWidth: 600 }} aria-label="customized table">
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell style={headStyle}><b>Date de réception</b></TableCell>
            ...
            <div className='footerFacture'>
                <u>Nom de fournisseur</u> : {factureInfo[2]}<br></br>
